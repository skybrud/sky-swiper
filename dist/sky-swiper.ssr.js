...
var __vue_staticRenderFns__ = [];
  ...
  /* module identifier */
  var __vue_module_identifier__ = "data-v-00c7f6ea";
  /* functional template */
...
}]},[_vm._ssrNode("<figure class=\"sky-swiper-wrap\">","</figure>",[_vm._ssrNode("<div"+(_vm._ssrClass(null,['sky-swiper-content', _vm.direction]))+">","</div>",[_c('transition',{attrs:{"name":_vm.config.animation.content}},[_c('div',{key:_vm.currentIndex,staticClass:"sky-swiper-content-item",attrs:{"keep-alive":""}},[_c('div',{staticClass:"sky-swiper-content-item-inner"},[_vm._t("content",null,{item:_vm.items[_vm.currentIndex],index:_vm.currentIndex})],2)])]),_vm._ssrNode(" "),(_vm.config.controls.previous)?_vm._ssrNode("<button class=\"sky-swiper-control previous\">","</button>",[_vm._ssrNode("<span class=\"sky-swiper-control-icon\">","</span>",[_vm._t("controls-previous",[_c('span',{domProps:{"textContent":_vm._s('<')}})])],2)]):_vm._e(),_vm._ssrNode(" "),(_vm.config.controls.next)?_vm._ssrNode("<button class=\"sky-swiper-control next\">","</button>",[_vm._ssrNode("<span class=\"sky-swiper-control-icon\">","</span>",[_vm._t("controls-next",[_c('span',{domProps:{"textContent":_vm._s('>')}})])],2)]):_vm._e()],2),_vm._ssrNode(" "),(_vm.config.navigation.location === 'before-caption')?_c('SkySwiperNavigation',{scopedSlots:_vm._u([{key:"bullet",fn:function(ref){
var active = ref.active;
var index = ref.index;
return _c('div',{},[_vm._t("bullets",null,{active:active,index:index})],2)}}])},[_c('div',{attrs:{"slot":"previous"},slot:"previous"},[_vm._t("navigation-previous")],2),_vm._v(" "),_c('div',{attrs:{"slot":"next"},slot:"next"},[_vm._t("navigation-next")],2)]):_vm._e(),_vm._ssrNode(" "),(_vm.$scopedSlots.caption)?_vm._ssrNode("<figcaption class=\"sky-swiper-caption-wrap\""+(_vm._ssrStyle(null,_vm.caption.style, null))+">","</figcaption>",[_vm._ssrNode("<div class=\"sky-swiper-caption\">","</div>",[_c('transition',{attrs:{"name":_vm.config.animation.caption}},_vm._l((_vm.items),function(item,index){return (index === _vm.currentIndex)?_c('div',{key:index,staticClass:"sky-swiper-caption-item"},[_c('div',{staticClass:"sky-swiper-caption-item-inner"},[_vm._t("caption",null,{item:item,index:index})],2)]):_vm._e()}))],1)]):_vm._e()],2),_vm._ssrNode(" "),(_vm.config.controls.cursor && !_vm.cursorProps.touch.active)?_vm._ssrNode("<div class=\"sky-swiper-cursor-area\""+(_vm._ssrStyle(null,_vm.cursorAreaStylePadded, null))+">","</div>",[_vm._ssrNode("<div class=\"cursor-area-content\""+(_vm._ssrStyle(null,_vm.cursorAreaStyle, null))+">","</div>",[_vm._ssrNode("<div class=\"sky-swiper-cursor-container\""+(_vm._ssrStyle(null,_vm.cursorStyle, null))+">","</div>",[_vm._ssrNode("<div"+(_vm._ssrClass(null,['sky-swiper-cursor', _vm.cursorDirection, {
						pressed: _vm.cursorProps.pressed
					}]))+">","</div>",[_vm._t("cursor",null,{direction:_vm.cursorDirection,active:_vm.cursorProps.active,pressed:_vm.cursorProps.pressed})],2)])])]):_vm._e(),_vm._ssrNode(" "),(_vm.config.navigation.location === 'after-caption')?_c('SkySwiperNavigation',[_vm._t("navigation-previous",null,{slot:"previous"}),_vm._v(" "),_vm._t("navigation-next",null,{slot:"next"})],2):_vm._e()],2)};
var __vue_staticRenderFns__$1 = [];
  ...
  /* module identifier */
  var __vue_module_identifier__$1 = "data-v-478b5a54";
  /* functional template */
