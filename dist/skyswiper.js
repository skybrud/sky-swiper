(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("sky-swiper", [], factory);
	else if(typeof exports === 'object')
		exports["sky-swiper"] = factory();
	else
		root["SkySwiper"] = factory();
...
exports.default = {
	...
	computed: {
		config: function config() {
			return {
				controls: (0, _assign2.default)({}, defaults.controls, this.controls),
				navigation: (0, _assign2.default)({}, defaults.navigation, this.navigation),
				animation: (0, _typeof3.default)(this.animation) === 'object' ? (0, _assign2.default)({}, defaults.animation, this.animation) : { content: this.animation, caption: this.animation }
			};
		},
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    class: ['sky-swiper', _vm.direction, ("slide-" + _vm.currentIndex), {
      'cursor-active': _vm.cursorProps.active
    }]
  }, [_c('figure', {
    staticClass: "sky-swiper-wrap"
  }, [_c('div', {
    ref: "content",
    class: ['sky-swiper-content', _vm.direction],
    on: {
    ...
    attrs: {
      "name": _vm.config.animation.content
    }
  }, [_c('div', {
    key: _vm.currentIndex,
    staticClass: "sky-swiper-content-item",
    attrs: {
      "keep-alive": ""
    }
  }, [_c('div', {
    staticClass: "sky-swiper-content-item-inner"
  }, [_vm._t("content", null, {
    item: _vm.items[_vm.currentIndex],
    index: _vm.currentIndex
  })], 2)])]), _vm._v(" "), (_vm.config.controls.previous) ? _c('button', {
    staticClass: "sky-swiper-control previous",
    on: {
    ...
    staticClass: "sky-swiper-control-icon"
  }, [_vm._t("controls-previous", [_c('span', {
    domProps: {
      "textContent": _vm._s('<')
    }
  })])], 2)]) : _vm._e(), _vm._v(" "), (_vm.config.controls.next) ? _c('button', {
    staticClass: "sky-swiper-control next",
    on: {
      "click": function($event) {
        _vm.goToNext()
      }
    ...
    ref: "caption",
    staticClass: "sky-swiper-caption"
  }, [_c('transition', {
    attrs: {
      "name": _vm.config.animation.caption
    }
  }, _vm._l((_vm.items), function(item, index) {
    return (index === _vm.currentIndex) ? _c('div', {
      key: index,
      staticClass: "sky-swiper-caption-item"
    }, [_c('div', {
      staticClass: "sky-swiper-caption-item-inner"
    }, [_vm._t("caption", null, {
      item: item,
      index: index
    })], 2)]) : _vm._e()
    ...
    on: {
      "mouseenter": _vm.onCursorEnter,
      "mouseleave": _vm.onCursorLeave,
      "mousemove": _vm.onCursorMove,
      "mousedown": _vm.onCursorDown,
      "mouseup": _vm.onCursorUp
    }
  }, [_c('div', {
    staticClass: "cursor-area-content",
    style: (_vm.cursorAreaStyle),
    on: {
      "click": _vm.onCursorClick
    }
  }, [_c('div', {
    staticClass: "sky-swiper-cursor-container",
    style: (_vm.cursorStyle)
  }, [_c('div', {
    ref: "cursor",
    class: ['sky-swiper-cursor', _vm.cursorDirection, {
